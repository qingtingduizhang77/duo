...
@Data
@NoArgsConstructor
@Table(name="ims_store_check_det")
public class ImsStoreCheckDet extends BaseEntity{ 
    ...
    private Double store_money;//金额

    private Double store_price;//单价

    private Double store_num;//数量
