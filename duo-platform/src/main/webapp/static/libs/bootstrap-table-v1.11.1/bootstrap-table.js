...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        initBodySuccess: function (data) {//add yonsin
        },
        trimOnSearch: true,
        clickToSelect: false,
        singleSelect: false,
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        // });
        this.$body.find('> tr[data-index]  > td > input[name="btSelectItem"]').off('click').on('click', function (event) {
            event.stopImmediatePropagation();
        ...
        this.$body.find('> tr[data-index] ').off('click').on('click', function (event) {
            event.stopImmediatePropagation();
            var index = $(this).data('index'),
                row = that.data[index];
            for(var i=0;i< that.data.length;i++){
                row[that.header.stateField]=false;
                if(i==index) row[that.header.stateField]=true;
            }
            that.$selectItem.filter(':checked').parent().parent().not(this).prop('checked', false);
            that.updateSelected();
            that.uncheckAll();
            that.check(index);
        });
        ...
        this.options.initBodySuccess(data);//add yonsin
    };
    ...
    var allowedMethods = [
        'getOptions', 'getRowByIndex', 'removeByIndex',
