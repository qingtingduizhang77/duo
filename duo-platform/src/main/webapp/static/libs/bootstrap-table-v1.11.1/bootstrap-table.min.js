...
!function (a) {
    ...
    o.DEFAULTS = {
        ...
        // }),
            this.$body.find('> tr[data-index]  > td > input[name="btSelectItem"]').off('click').on('click', function (b) {
                    b.stopImmediatePropagation();
                    var c = a(this), e = c.prop("checked"), f = d.data[c.data("index")];
                    d.options.maintainSelected && a(this).is(":radio") && a.each(d.options.data, function (a, b) {
                        b[d.header.stateField] = !1
        ...
        this.$body.find('> tr[data-index] ').off('click').on('click', function (event) {
            ...
            for(var i=0;i< d.data.length;i++){
                row[d.header.stateField]=false;
                if(i==index) row[d.header.stateField]=true;
            }
            d.$selectItem.filter(':checked').parent().parent().not(this).prop('checked', false);
            d.updateSelected();
            d.uncheckAll();
            d.check(index);
        }),
        ...
        }), this.updateSelected(), this.resetView(), this.trigger("post-body", f), this.options.initBodySuccess(f)
