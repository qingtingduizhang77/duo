...
+function (a) {
    ...
    d.VERSION = "0.11.9", d.INPUT_SELECTOR = ':input:not([type="hidden"], [type="submit"], [type="reset"], button)', d.FOCUS_OFFSET = 20, d.DEFAULTS = {
        ...
        var c = this.options.html ? "html" : "text", d = b.data("bs.validator.errors"), e = b.closest("div"),//.form-group改为div
        ...
        var c = a.closest("div"), d = c.find(".help-block.with-errors"), e = c.find(".form-control-feedback");
