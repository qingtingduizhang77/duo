...
insert  into `user_doctor`(`doctor_id`,`project_id`,`auditing`,`user_code`,`user_id`,`doctor_name`,`hospital_name`,`special_area`,`descript`,`img_url`,`class_type`,`memo`,`add_userid`,`add_date`,`modify_userid`,`modify_date`,`record_flag`,`doctor_type`,`sex`,`id_card`,`qualify_no`,`from_date`,`office_room`,`qualify_level`,`mobile_no`,`address`,`sum_money`,`balance_money`,`applying_money`) values ('832259332197646892','','0','test','a1001','张医生','板芙医院','','','','1','','admin','2020-07-14 16:51:50',NULL,NULL,'0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
insert  into `user_member`(`member_id`,`project_id`,`auditing`,`member_name`,`sex`,`both_date`,`address`,`mobile_no`,`e_mail`,`id_card`,`social_card`,`member_level`,`usable_point`,`total_point`,`order_num`,`order_money`,`nick_name`,`user_code`,`user_password`,`limit_date`,`memo`,`add_userid`,`add_date`,`modify_userid`,`modify_date`,`record_flag`) values ('892513600193274424','','0','宾欢','1','2020-08-24 00:00:00','','','','','','1',0,0,0,0,'bing','','',NULL,'','admin','2020-08-24 06:59:16','admin','2020-08-24 07:01:48','0');
...
insert  into `user_member_man`(`man_id`,`project_id`,`member_id`,`man_name`,`sex`,`both_date`,`address`,`mobile_no`,`e_mail`,`id_card`,`social_card`,`past_history`,`drug_allergy`,`genetic_disease`,`height`,`weight`,`memo`,`add_date`,`modify_userid`,`modify_date`,`record_flag`) values ('892530281846260592','','892513600193274424','11','1','2020-08-20 00:00:00','','222333','','','','','','','','','','2020-08-24 08:30:24','admin','2020-08-24 08:30:43','0');
