...
public final class RedisUtil {
    ...
    public static Object lPop(String key) {
        try {
            Object obj = redisUtil.redisTemplate.opsForList().leftPop(key);
            return obj;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
    ...
    public static Object rPop(String key) {
        try {
            Object obj = redisUtil.redisTemplate.opsForList().rightPop(key);
            return obj;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
     ...
     * @return 左边拿到的数据
     */
    public static Object lPop(String key,long timeout) {
        try {
            Object obj = redisUtil.redisTemplate.opsForList().leftPop(key,timeout,TimeUnit.SECONDS);
            return obj;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
     ...
     * @return 左边拿到的数据
     */
    public static Object rPop(String key,long timeout) {
        try {
            Object obj = redisUtil.redisTemplate.opsForList().rightPop(key,timeout,TimeUnit.SECONDS);
            return obj;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
     ...
     * @return 左边拿到的数据
     */
    public static Object put(String key,long timeout) {
        try {
            Object obj = redisUtil.redisTemplate.opsForList().leftPop(key,timeout,TimeUnit.SECONDS);
            return obj;
        } catch (Exception e) {
    ...
    public static Long lSize(String key) {
        try {
            Long num = redisUtil.redisTemplate.opsForList().size(key);
            return num;
        } catch (Exception e) {
            e.printStackTrace();
            return 0L;
    ...
    public static Long lPush(String key, Object value) {
        try {
            Long num = redisUtil.redisTemplate.opsForList().leftPush(key,value);
            return num;
        } catch (Exception e) {
            e.printStackTrace();
            return 0L;
    ...
    public static Long rPush(String key, Object value) {
        try {
            Long num = redisUtil.redisTemplate.opsForList().rightPush(key,value);
            return num;
        } catch (Exception e) {
            e.printStackTrace();
            return 0L;
     ...
     * @return 数量
     */
    public static Long lPushAll(String key, Collection collection) {
        try {
            Long num = redisUtil.redisTemplate.opsForList().leftPushAll(key,collection);
            return num;
        } catch (Exception e) {
            e.printStackTrace();
            return 0L;
     ...
     * @return 数量
     */
    public static Long rPushAll(String key, Collection collection) {
        try {
            Long num = redisUtil.redisTemplate.opsForList().rightPushAll(key,collection);
            return num;
        } catch (Exception e) {
            e.printStackTrace();
            return 0L;
