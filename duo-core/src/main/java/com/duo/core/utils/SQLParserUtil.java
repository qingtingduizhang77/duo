...
import com.duo.core.enums.SqlType;
...
public class SQLParserUtil {
     ...
     *     Select statement = (Select) SQLParserUtil.getStatement(sql);
     *  }
     * @param sql
     * @return
     * @throws JSQLParserException
    ...
    public static FromItem getFromItem(SelectBody selectBody){
        if(selectBody instanceof PlainSelect){
            ...
            SQLParserUtil.getFromItem(((WithItem) selectBody).getSelectBody());
        }
        return null;
    }
    ...
    public static SubSelect getSubSelect(SelectBody selectBody){
        if(selectBody instanceof PlainSelect){
            ...
            SQLParserUtil.getSubSelect(((WithItem) selectBody).getSelectBody());
        }
        return null;
    }
